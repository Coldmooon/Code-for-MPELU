...
class Net(nn.Module):
    def __init__(self):
        ...
        self.mpelu1 = MPELU(32)
        self.conv2 = nn.Conv2d(32, 64, 3, 1)
        self.mpelu2 = MPELU(64)
        self.dropout1 = nn.Dropout(0.25)
        self.dropout2 = nn.Dropout(0.5)
        self.fc1 = nn.Linear(9216, 128)
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1)) # Global Average Pooling Layer
        self.fc2 = nn.Linear(64, 10) # fc2 now takes 64 input channels instead of 128
...
def test(model, device, test_loader):
    ...
    test_loss = 0
    correct = 0
    print('mpelu parameters: ', model.mpelu1.a.mean().item())
    with torch.no_grad():
