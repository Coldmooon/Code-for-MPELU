...
function Trainer:train(epoch, dataloader)
   ...
   -- Use multiple learning rate and weight decay like caffe. -- coldmooon
   -------------------------------------------------------------
   learning_rates, weight_decays = self.model:getOptimConfig(self.optimState.learningRate, self.opt.weightDecay)

   self.optimState.learningRates = learning_rates
   self.optimState.weightDecay = nil
   self.optimState.weightDecays = weight_decays
...
function Trainer:learningRate(epoch)
   ...
   elseif self.opt.dataset == 'cifar10' then
      ...
      -- lr_mult = epoch >= 150 and 10 or epoch >= 122 and 100 or epoch >= 81 and 10 or 1
   ...
   -- use lr_mult like caffe:
   -- for k,v in pairs(self.model:findModules('nn.SPELU')) do
